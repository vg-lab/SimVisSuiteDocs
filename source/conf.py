...
htmlhelp_basename = 'SimVisSuiteDevelopersDocumentationdoc'
...
latex_documents = [
    (master_doc, 'SimVisSuiteDevelopersDocumentation.tex', 'SimVisSuite Developers Documentation',
     'Félix de las Pozas Álvarez', 'manual'),
]
...
\begin{center}
  \vspace*{250px}
  {\Huge SimVisSuite Developers Documentation}\\[4ex]
  {\Large Version 1.0.0}\\[4ex]
  {\Large F\'{e}lix de las Pozas \'{A}lvarez}\\[4ex]
  {\Large September 2023}\\[16ex]
...
% add copyright stuff
    \fancyfoot[LO,RE]{{ \textcopyright\ 2023 Visualization \& Graphics Lab VG-Lab URJC.}}
